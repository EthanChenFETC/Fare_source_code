...
Public Module PathManager
    ...
    Public Function GetUploadPath() As String
        Dim UploadPath As String = RemoveXSS(System.Configuration.ConfigurationManager.AppSettings("UploadPath").ToString.Replace("~/", ""))
    ...
    Public Function FullDomainUrl() As String
        ...
        Dim servername As String = RemoveXSS(ConfigurationManager.AppSettings("SiteDomainName").ToString) 'RemoveXSS(Context.Request.ServerVariables("SERVER_NAME"))
        'Dim SERVER_PORT As String = RemoveXSS(Context.Request.ServerVariables("SERVER_PORT"))
        ...
        'ThisDomain = ThisDomain & ApplicationPath
    ...
    Public Function GetPathFileNameNoExten(ByVal Webform As System.Web.UI.Page) As String
        ...
        Dim PathFileName As String = GetPathFileName(Webform)
    ...
    Public Function GetPathFileName(ByVal Webform As System.Web.UI.Page) As String
        ...
        Dim tmpAppName As String = Webform.Request.Path
