...
Partial Class common_PublishBlock
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim sql As String = "SELECT Content FROM PublishBlock WHERE BlockID = @BlockUD"
        Using dr As SqlDataReader = ClassDB.GetDataReaderParam(sql, New SqlParameter("@BlockUD", _BlockID))
            Try
                If dr IsNot Nothing Then
                    If dr.Read Then
                        Dim Content As String = dr("Content").ToString
                        Me.lbContent.Text = Content '.Replace(vbCrLf, "<br/>")
                    End If
                End If
