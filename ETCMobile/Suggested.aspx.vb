...
Partial Class _Suggested
    ...
    Dim Remind As String = ConfigurationManager.AppSettings("SuggestRemindMobile").ToString
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.ddlTimePediod.Attributes.Add("onchange", "document.getElementById('" & Me.hidd1.ClientID & "').value = this.value;return false;")
        Me.imgCalculate.Attributes.Add("onkeypress", "javascript:__doPostBack('" & imgCalculate.ClientID.Replace("_", "$") & "','')")
    ...
    Protected Sub imgCalculate_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgCalculate.Click
        ...
        If Regex.IsMatch(UserIP.Replace(":", "").Replace(".", "").Replace("-", "").ToString.Trim, "^[0-9]+$") And Not CheckSqlInjectionWording(UserIP.Replace(":", "").Replace(".", "").Replace("-", "").ToString.Trim) Then


            Dim SessionID As String = Session("SessionID")

            'ClassDB.UpdateDB("farecalculatorLogInsert",
            '             New SqlParameter("SiteID", 2),
            ...
            'Dim sqlStr As String = "update FareCalculateCount set MSuggestCount = MSuggestCount + 1, LastUpdateMSuggest = getdate() where SiteID = 2 and convert(varchar(20), getdate(), 112) = LastUpdateDateTime "
...
#Region "計算費率"
    ...
    Private Function FareCalcaulate(ByVal StartIC As Integer, ByVal StopIC As Integer, ByVal StartHW As Integer, ByVal StopHW As Integer) As DataTable
        ...
        Dim dtProhibit As String = Fare.GetInterChangeProhibitRouteString
        Dim i As Integer = 0
        ...
        If Not isBestFare Then
            Try
                'Route = getNextRoute(StartIC, StopIC, StartIC, dtRelation, dtIC, dtProhibit, Route, RouteF)
                getNextRoute(StartIC, StopIC, StartIC, dtRelation, dtIC, dtProhibit, Route, RouteF)
            Catch ex As Exception
