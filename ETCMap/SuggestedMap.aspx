<%@ Page Language="VB" MasterPageFile="~/MasterPageFare.master" AutoEventWireup="false" CodeFile="SuggestedMap.aspx.vb" 
    Inherits="_SuggestedMap"  EnableEventValidation="false" EnableViewStateMac="false" EnableViewState="false"  ViewStateEncryptionMode="Never"%>
...
<ContentTemplate>
            ...
            <td colspan="3" align="center" valign="top">
                <p>
                    <!--     將imagebutton 改成 link button 避免mac 驗證的問題 Chris 20171204      --->
                     <asp:LinkButton ID="lkbtCalculate" runat="server" Text="開始計算"><img src="images/btn_star.jpg" border="0" width="204px" height="57px" alt="開始計算!"  onmouseover="this.src='images/btn_star_a.jpg'" onfocus="this.src='images/btn_star.jpg'" onmouseout="this.src='images/btn_star.jpg'" onblur="this.src='images/btn_star_a.jpg'" /></asp:LinkButton> 
