...
Partial Class _SuggestedMapNew1
    ...
    Protected Sub imgCalculate_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgCalculate.Click
        ...
        If TransitIC <> 0 Then
            ...
            'BestRouteName1 = "從" & HWName(dtIC.Select("UID=" & StartIC)(0)("HWUID")) & " " & dtIC.Select("UID=" & StartIC)(0)("ICName") & " 到 " & HWName(dtIC.Select("UID=" & TransitIC)(0)("HWUID")) & dtIC.Select("UID=" & TransitIC)(0)("ICName") & "<br/> 詳細路線:<br/>"
        ...
        dt = FareCalcaulate(StartIC, StopIC, HWStart, HWStop, Route1)
        If dt.Rows.Count = 0 Then
        ...
        BestRouteName = "詳細路線:<br/>" & BestRouteName.Substring("&#8594;".Length) & "<br/><br/>"
        ...
        If Not CheckSqlInjectionWording(UserIP.Replace(":", "").Replace(".", "").Replace("-", "").ToString.Trim) And Regex.IsMatch(UserIP.Replace(":", "").Replace(".", "").Replace("-", "").ToString.Trim, "^[0-9]+$") Then
            ...
            ReturnRouteLines(dt.Rows(0)("Route"))
...
#Region "計算費率"
    ...
    Private Function FareCalcaulate(ByVal StartIC As Integer, ByVal StopIC As Integer, ByVal StartHW As Integer, ByVal StopHW As Integer, ByVal existRoute As String) As DataTable
        RoutePass = ""
        '先把所有的交流道選出來
