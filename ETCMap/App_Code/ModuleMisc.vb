...
Public Module ModuleMisc
    ...
    Public Function removeSpecialCharacters(ByVal str As String) As String
        If str Is Nothing Then
            Return Nothing
        End If
        Dim AllString As String = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890"
        Dim resultStr As StringBuilder = New StringBuilder
        Dim i As Integer
        For i = 0 To str.Length - 1
            Dim singleWord As String = str.Substring(i, 1)
            If AllString.IndexOf(singleWord) >= 0 Then
                resultStr.Append(singleWord)
            End If
        Next
