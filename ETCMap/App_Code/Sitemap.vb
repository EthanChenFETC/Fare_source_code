...
Public Module Sitemap
    ...
    Public Sub RemoveCacheKey(ByVal CacheKeyFileString As String)
        ...
        If FileIO.FileSystem.FileExists(Context.Server.MapPath(CacheKeyDic & CacheKeyFileString)) Then
            FileIO.FileSystem.DeleteFile(Context.Server.MapPath(CacheKeyDic & CacheKeyFileString))
        End If
    End Sub
    ...
    Public Function GetNodeText_Auto(ByVal WebForm As System.Web.UI.Page) As String
        ...
        If IsNumeric(NodeID) Then
            '取得此NOdeID的節點名稱
            'NodeID = CInt(WebForm.Request.Params("cnid"))
    ...
    Public Function GetNodeID_Auto(ByVal WebForm As System.Web.UI.Page) As Integer
        ...
        ElseIf IsNumeric(cnhb) Then
            '無NodeID,有單元關鍵字碼
            'NodeID = cnhb 'GetNodeID_byUrlString(PathManager.ApplicationUrl & "Default.aspx")
            NodeID = 0
        Else
            '其他情況時以網址取得NodeID
    ...
    '    Dim SiteID As Integer = CInt(System.Configuration.ConfigurationManager.AppSettings("SiteID").ToString)
    '    SiteID = CInt(SiteID)
    '    Dim NodeID As Integer
    '    If IsNumeric(SiteID) Then
    '        NodeID = ClassDB.RunSPReturnInteger("Net2_SiteMap_GetNodeID_byNodeKeyword",
    ...
    Public Function GetNodeID_byUrl(ByVal WebForm As System.Web.UI.Page) As Integer
        ...
        If Url.Replace(ApplicationUrl, "").ToLower.Equals("/default.aspx") Then
            RootFlag = True
        End If
...
#Region "Nav Bar"
    ...
    Public Function BuildNavBar(ByVal Webform As System.Web.UI.Page) As String
        If Webform.Request.Params("cnhb") IsNot Nothing Then
            ...
            If Not System.Configuration.ConfigurationManager.AppSettings("NavigationHomeText") Is Nothing Then
                HomeText = System.Configuration.ConfigurationManager.AppSettings("NavigationHomeText").ToString
            End If
        ...
        For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
            ...
            If IsDBNull(dtRow("NodeID")) Then
                Continue For
            End If
            If CInt(dtRow("NodeID")) = (NodeID) Then
        ...
        If NodeIDSeril = "" And Not System.Configuration.ConfigurationManager.AppSettings("NavigationHomeText") Is Nothing Then
            HomeText1 = RemoveXSS(System.Configuration.ConfigurationManager.AppSettings("NavigationHomeText").ToString)
    ...
    Public Function GetNodeText_byCNHB(ByVal GroupID As Integer) As String
        ...
        Dim NodeText As String = ""
        Using dr As SqlDataReader = ClassDB.GetDataReaderParam("Select GroupName from SitemapGroupCatgry where GroupID = @GroupID", New SqlParameter("@GroupID", CInt(GroupID))) ''" & GroupID & "'")
            Try
...
#End Region
    ...
    Public Function CheckSiteMap(ByVal Webform As System.Web.UI.Page) As Boolean
        Dim ret As Boolean = False
        Dim cnhb As String = Webform.Request.QueryString.Item("cnhb")
        Dim p As String = Webform.Request.QueryString("p")
        ...
        If IsNumeric(ThisSiteID) Then
            ...
            If Not ret And cnid > 0 Then
                ...
                Using dr As SqlDataReader = ClassDB.GetDataReaderParam(Str, New SqlParameter("@NodeID", cnid), New SqlParameter("@SiteID", ThisSiteID))
                    If dr IsNot Nothing Then
                        If dr.Read Then
                            ret = True
                        End If
