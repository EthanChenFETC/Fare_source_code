...
#Region "Faq List"
    ...
    Private Sub BindPager(ByVal dt As DataTable, Optional ByVal Show As Boolean = True)
        ...
        If dt Is Nothing Then
            Me.ltlPageCount.Text = "頁碼 0 頁 總計 0 筆資料"
            Exit Sub
        Else
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        If e.CommandName = "ViewItem" Then
            ...
            Dim PublicID As Integer = 0
            Try
                PublicID = IIf(IsNumeric(e.CommandArgument), e.CommandArgument, 0)
                Me.MultiView1.ActiveViewIndex = 1
                doBindData(PublicID)
            Catch ex As Exception
                Me.MultiView1.ActiveViewIndex = 0
        ...
        If e.CommandName = "ViewPager" Then
            Try
                Me.GridView1.PageIndex = IIf(IsNumeric(e.CommandArgument), 0, e.CommandArgument)
                Me.GridView1.DataBind()
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            If ((e.Row.RowState = DataControlRowState.Normal) OrElse (e.Row.RowState = DataControlRowState.Alternate) OrElse (e.Row.RowState = DataControlRowState.Alternate) OrElse (e.Row.RowState = DataControlRowState.Selected)) Then
                Try
            ...
            Try
                If dr IsNot Nothing Then
                    If dr.Read Then
                        ...
                        '''''''''''''''''''''''
                        Me.Label4.Text = RemoveXSS(System.Configuration.ConfigurationManager.AppSettings("SiteName").ToString)
                        ...
                        If IsDBNull(dr.Item("AttFiles")) Or dr.Item("AttFiles") Is Nothing Then
                            FileManager1.Visible = False
                        Else
                            If dr.Item("AttFiles").ToString.Trim.Length > 0 Then
